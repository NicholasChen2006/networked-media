...
//morning
  if (hour > 5 && hour <= 9) {
    ...
    document.getElementById("background").src = "Clockimages/snow-2.png";
  }
//noon
  //else if stops when the conditions are met for one of them
   else if (hour > 9 && hour <= 17) {
    //retrieve element by id of background
    document.getElementById("background").src = "Clockimages/snow-3.png";
  }
//sunset
  else if (hour > 17 && hour <= 19) {
    //retrieve element by id of background
    document.getElementById("background").src = "Clockimages/snow-4.png";
  }
//night
  else {
    //retrieve element by id of background
    document.getElementById("background").src = "Clockimages/snow-1.png";
  }
  clock.textContent = temp;
  //   console.log(temp);
};
